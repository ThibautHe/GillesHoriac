...
export const Books = [
  ...
  },
  {
    ...
    description:
      "Nicolas Lurquin mène la vie paisible d’un bon père de famille près de Bruxelles. Un jour, il reçoit l’e-mail d’un notaire de Montpellier l’invitant à l’ouverture du testament de son oncle Guillaume Faviau. Bien que ce nom lui soit parfaitement inconnu, il se rend dans le Languedoc, où le notaire lui apprend qu’il est l’unique héritier d’une somme avoisinant les 10 millions d’euros. Sa surprise est encore plus grande lorsqu’il s’aperçoit que sur sa carte d’identité, son nom a été remplacé par celui de Paul Faviau.",
    price: "15.00",
